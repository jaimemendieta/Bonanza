...
export const dictionary: Record<string, DictionaryEntry> = {
    ...
    es: {
        ...
        commitmentToChildrenDescription2: "La dedicación inquebrantable de Giannina se refleja en su trabajo como trabajadora de bienestar infantil para la División de Servicios para Niños y Familias, enfocándose el bienestar de los más necesitados.",
